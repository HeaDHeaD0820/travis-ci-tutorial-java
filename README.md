[![Build Status](https://app.travis-ci.com/HeaDHeaD0820/travis-ci-tutorial-java.svg?branch=master)](https://app.travis-ci.com/HeaDHeaD0820/travis-ci-tutorial-java)
...
[Click here for the example using GitHub Actions instead of Travis CI](https://github.com/HeaDHeaD0820/travis-ci-tutorial-java)

# How To Start

1. [Fork](https://github.com/HeaDHeaD0820/travis-ci-tutorial-java/fork) this Repository
...
- Add your repository (you can go there directly by going to https://codecov.io/gh/HeaDHeaD0820/travis-ci-tutorial-java)
